...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  let palabrasSepradas = str.split(" ")

  for (let i = 0; i < palabrasSepradas.length; i++) {
    palabrasSepradas[i] = palabrasSepradas[i].split("").reverse().join("")
  }
  return palabrasSepradas.join(" ")
